...
Because my data is raw, there is no explicit treatment, control, or variable that was trying to be studied during data collection. However, in the context of my research, the key independent variables are the population and propotion of Asians in CA-38 and the key dependent variable are the number and proportion of votes casted for a particular candidate in a particular election. **add design type and treatment (demographic shift, basically)**
...
linda18_table |>
  ...
  kable_styling() |>
  add_header_above(c("Votes for Linda Sánchez in 2018 Regression Values" = 2))
...
linda20_table |>
  ...
  knitr::kable(digits = 3) |>
  kable_styling() |>
  add_header_above(c("Votes for Linda Sánchez in 2020 Regression Values" = 2))
...
linda22_table |>
  ...
  knitr::kable(digits = 3) |>
  kable_styling() |>
  add_header_above(c("Votes for Linda Sánchez in 2022 Regression Values" = 2))
...
cngdem20_table |>
  ...
  knitr::kable(digits = 3) |>
  kable_styling() |>
  add_header_above(c("Democrat Regression Values" = 2))
...
cngrep20_table |>
  ...
  knitr::kable(digits = 3) |>
  kable_styling() |>
  add_header_above(c("Republican Regression Values" = 2))
...
summary_cngdem22 <- summary(cngdem22_table)
intercept_p_value <- summary_cngdem22$coefficients["(Intercept)", "Pr(>|t|)"]
coefficients_p_values <- summary_cngdem22$coefficients[, "Pr(>|t|)"]
cat("Intercept p-value:", intercept_p_value, "\n")
cat("Coefficients p-values:\n")
print(coefficients_p_values)
...
-   which one is my main coefficient of interest?

-   how to figure out if it is statistically significant? how to interpret causally?
